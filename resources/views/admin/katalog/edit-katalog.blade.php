                    ...
                    <div class="card-body">
                        <form action="{{ route('produk-update', $produk->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="nama-produk" value="{{ $produk->nama }}" name="nama" required />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="harga-produk">Harga</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="harga-produk" value="{{ $produk->harga }}" name="harga" required />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="deskripsi-produk">Deskripsi</label>
                                <div class="col-sm-10">
                                    <textarea id="deskripsi-produk" class="form-control" rows="3" name="deskripsi" required>{{ $produk->deskripsi }}</textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="foto-produk">Foto Produk</label>
                                <div class="col-sm-10">
                                    <input type="file" class="form-control" id="foto-produk" name="foto" />
                                </div>
                            </div>
